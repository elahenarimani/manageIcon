...
export const Three: React.FC<IIcon> = ({color="#000" , size=24}) => {
    return (
        <svg width={size} height={size} viewBox="0 0 173 174" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="0.5">
                <path opacity="0.5" d="M107.725 141.551C117.659 138.323 117.624 110.173 107.415 78.7518C97.2052 47.3306 80.7602 24.5128 70.7532 27.7643" stroke={color} />
                <path opacity="0.5" d="M107.725 141.551C117.659 138.323 117.624 110.173 107.415 78.7518C97.2052 47.3306 80.7602 24.5128 70.7532 27.7643" stroke={color} />
            </g>
            ...
            <path opacity="0.5" d="M107.724 141.551C97.686 144.812 81.2721 121.984 71.0628 90.563C60.8534 59.1418 60.7146 31.0259 70.7527 27.7643" stroke={color} />
            <defs>
